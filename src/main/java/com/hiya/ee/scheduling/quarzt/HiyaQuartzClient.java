...
public class HiyaQuartzClient
{
    public static void main(String[] args)
    {
        try
        {
            ...
            // 定义一个JobDetail
            JobDetail job = newJob(HiyaJob.class) // 定义Job类为HelloQuartz类，这是真正的执行逻辑所在
           ...
           // excludeDay.setTime(newDate().inMonthOnDay(2, 25).build());
            ...
            Trigger trigger2 = newTrigger().withIdentity("trigger1", "group1") 
                .startNow()//一旦加入scheduler，立即生效
